...
Begin           | Playing
:---------------------:|:------------------:
![screenshoot](screenshots/fg1.png) | ![screenshoot](screenshots/fg2.png)
...
4. Open the ```FISH.pde``` file.
5. Run it :)

## How To Play It
It's easy!
1. Use arrow keys to move the boat left or right..
2. Press space to throw the hook.
